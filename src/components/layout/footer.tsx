          ...
          >
            {socialLinks.map((social) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-9 h-9 rounded-xl border border-border bg-card/40 hover:border-primary/30 hover:bg-card/80 flex items-center justify-center text-muted-foreground hover:text-foreground transition-all duration-200"
              >
                {social.icon}
              </motion.a>
            ))}
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground/60">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              className="inline-flex items-center gap-0.5 text-muted-foreground hover:text-foreground transition-colors"
            >
              Tailwind CSS <ArrowUpRight size={11} />
            </a>
          </div>
        </div>
      </div>
